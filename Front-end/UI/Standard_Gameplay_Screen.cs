    ...
    public partial class Standard_Gameplay_Screen : Form
    {
        ...
        private void ans1_Click(object sender, EventArgs e)
        {
            if (!isButtonClicked)
            {
                ...
                clickedButton.BorderColor = Color.
        ...
        private void start()
        {
                ...
                question ques = JsonConvert.DeserializeObject<question>(DataContainer.response_msg);
                ...
                answers = JsonConvert.DeserializeObject<List<answer>>(DataContainer.response_msg);
        ...
        private void countDownTimer_Tick(object sender, EventArgs e)
        {
            time_label.BeginInvoke((MethodInvoker)delegate () {
                ...
                if (seconds < 0)
                {
                    ...
                    seconds = DataContainer.room.TimePerRound; // Reset timer for next round
                    time_label.Text = seconds.ToString()+"s";
                    DataContainer.flush();
